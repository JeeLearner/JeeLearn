...
public class RepositoryHelper {
    ...
    public static EntityManager getEntityManager() {
        Assert.notNull(entityManager, "entityManager must null, please see " +
                "[com.learn.common.jdbc.jpa.dao.RepositoryHelper#setEntityManagerFactory]");
    ...
    /**
     * <p>ql条件查询<br/>
     * searchCallback默认实现请参考 {@see com.learn.common.jdbc.jpa.dao.callback.DefaultSearchCallback}<br/>
     * <p/>
