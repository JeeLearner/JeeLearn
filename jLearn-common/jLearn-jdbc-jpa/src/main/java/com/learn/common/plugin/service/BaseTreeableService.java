package com.learn.common.plugin.service;
...
import com.learn.common.base.utils.ReflectUtils;
import com.learn.common.jdbc.jpa.dao.RepositoryHelper;
...
import com.learn.common.jdbc.jpa.entity.search.filter.SearchFilterHelper;
...
public class BaseTreeableService<M extends BaseEntity<ID> & Treeable<ID>, ID extends Serializable>
	 ...
	 * @param m
	 * @return
	 * @see com.learn.common.jdbc.jpa.service.BaseService#save(com.learn.common.jdbc.jpa.entity.AbstractEntity)
	 */
	@Override
	public M save(M m) {
		if (m.getWeight() == null) {
    ...
    public List<M> findAncestor(String parentIds) {
        if (org.apache.commons.lang3.StringUtils.isEmpty(parentIds)) {
            return Collections.EMPTY_LIST;
        }
