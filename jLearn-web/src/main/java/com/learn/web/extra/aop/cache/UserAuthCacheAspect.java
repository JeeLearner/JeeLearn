...
import com.learn.common.service.sys.auth.AuthService;
import com.learn.common.service.sys.group.GroupRelationService;
 ...
 * <p/>
 * 1、当调用如下方法时，加缓存
 * {@link com.learn.common.service.sys.auth.UserAuthService#findRoles}
 * {@link com.learn.common.service.sys.auth.UserAuthService#findStringRoles}
 * {@link com.learn.common.service.sys.auth.UserAuthService#findStringPermissions}
 * <p/>
 * 2、授权（Auth）
 * 当增删改授权时，
 * 如果是用户相关的，只删用户的即可，
...
public class UserAuthCacheAspect extends BaseCacheAspect {
     ...
     * 其他的全部清理
     */
    @Pointcut(value = "target(com.learn.common.service.sys.auth.AuthService)")
     ...
     * 当删除权限时，清缓存
     */
    @Pointcut(value = "target(com.learn.common.service.sys.permission.PermissionService)")
     ...
     * 当修改角色show/role/resourcePermissions关系时，清缓存
     */
    @Pointcut(value = "target(com.learn.common.service.sys.permission.RoleService)")
     ...
     * 当删除/修改show字段时，清缓存
     */
    @Pointcut(value = "target(com.learn.common.service.sys.organization.OrganizationService)")
     ...
     * 当删除/修改show字段时，清缓存
     */
    @Pointcut(value = "target(com.learn.common.service.sys.organization.JobService)")
     ...
     * 当删除组时，清缓存
     */
    @Pointcut(value = "target(com.learn.common.service.sys.group.GroupService)")
     ...
     * 其他情况，清所有
     */
    @Pointcut(value = "target(com.learn.common.service.sys.group.GroupRelationService)")
    ...
    @Pointcut(value = "target(com.learn.common.service.sys.auth.UserAuthService)")
