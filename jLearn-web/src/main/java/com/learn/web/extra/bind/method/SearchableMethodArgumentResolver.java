package com.learn.web.extra.bind.method;
...
import com.learn.web.extra.bind.method.base.BaseMethodArgumentResolver;
 ...
 *     查询参数格式如下：
 *     1.1、默认查询字符串
 *         search.baseInfo.realname_like=jeeLearn
 *         search.age_lt=12
 ...
 *
 *     2.1、自定义查询字符串
 *         foo_search.baseInfo.realname_like=jeeLearn
